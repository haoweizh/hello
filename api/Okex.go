...
func getBalanceOKEX(key, secret string) (success bool, balances []*model.Balance) {
	...
	details := balanceArray[0].(map[string]interface{})[`details`]
	for _, item := range details.([]interface{}) {
