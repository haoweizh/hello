...
//	settings := api.GetSettings(model.FunctionCross, model.KucoinPerp)
//	if settings == nil {
//		return
//	}
...
//	symbols := api.GetMarketSymbols(model.KucoinPerp)
...
//
//			funcHandlers := api.GetFunctions(model.KucoinPerp, symbol)
//			if funcHandlers != nil {
//				funcHandlers.Range(func(function, value interface{}) bool {
//					setting := api.GetSetting(function.(string), model.KucoinPerp, symbol)
...
//
//func getPositionsKucoinPerp(key string, secret string) (success bool, positions []*api.Position, accountValue, availableU float64) {
//	//params := make(map[string]string)
