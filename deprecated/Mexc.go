...
//			} else {
//				api.SetRequireReset(model.Mexc)
//			}
//		}
//	}
//}
...
//				funcHandlers := api.GetFunctions(model.Mexc, symbol)
//				if funcHandlers != nil {
//					funcHandlers.Range(func(function, value interface{}) bool {
//						setting := api.GetSetting(function.(string), model.Mexc, symbol)
...
//	symbols := api.GetMarketSymbols(model.Mexc)
//	if !useFullDepthSub {
...
//		subscribes = api.GetWSSubscribes(model.Mexc, []string{mexcContractDepthIncSubType})
//	} else { // 订阅contract 5档深度全量
//		subscribes = api.GetWSSubscribes(model.Mexc, []string{mexcContractDepthFullSubType})
//	}
...
//}
//
//func getPositionsMexc(key, secret string) (success bool, positions []*api.Position, accountValue, availableU float64) {
...
//		position := &api.Position{Market: model.Mexc, Ts: util.GetNowUnixMillion()}
