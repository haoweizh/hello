...
////}
//
//func getHoldingHuobiPerp(key, secret, symbolSide string) (position *api.Position) {
...
//				continue
//			}
//			position = &api.Position{Market: model.HuobiPerp, Ts: util.GetNowUnixMillion(), Currency: symbol}
