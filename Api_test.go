...
func Test_CreateReport(t *testing.T) {
	...
	timeRage := `2022-09-01T00:00:00+00:00~2023-03-21T00:00:00+00:00`
...
func Test_CutTail(t *testing.T) {
	...
	//allLimit := 12
	market := model.BinancePerp
	strBegin := `2022-09-01T00:00:00+00:00`
	strEnd := `2023-03-21T00:00:00+00:00`
	//coins := `CZCE.FG,DCE.jm,DCE.eb,CZCE.TA,SHFE.fu,DCE.p,CZCE.SF,SHFE.hc,DCE.v,DCE.y`
	coins := `DOGE,SOL,MATIC,CHZ,LINK,ADA,BNB,FIL,SUSHI,AXS,ATOM,WAVES`
	//coins = `BTC`
...
func Test_Orders(t *testing.T) {
	...
	order := api.PlaceOrder(account.Key, account.Secret, model.OrderSideSell, model.OrderTypeLimit, markets[0], symbol, model.ReduceOnly,
